...
mods.thermalexpansion.Pulverizer.removeRecipe(<extrautils2:compressedsand>);
mods.thermalexpansion.Pulverizer.removeRecipe(<extrautils2:compressedsand:1>);
